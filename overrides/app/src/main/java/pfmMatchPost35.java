...
public final class pfmMatchPost35 {
    ...
    public static void runDiscipline(){byte[] y=pfmLeagueMatchArchive34.yellowSnapshot(),r=pfmLeagueMatchArchive34.redSnapshot();try{pfmDiscipline70.onMatchdayCompleted();}finally{try{pfmLeagueMatchArchive34.applyCards(y,pfmLeagueMatchArchive34.yellowSnapshot(),r,pfmLeagueMatchArchive34.redSnapshot(),completedRoundOne());}catch(Throwable ignored){}}}
}
